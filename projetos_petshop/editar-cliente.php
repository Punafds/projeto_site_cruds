    ...
    <div class="mb-3">
        <label>Nome
            <input type="text" name="nome_cliente" class="form-control" 
                   value="<?php echo $row->nome_cliente; ?>" required>
        </label>
    </div>
    ...
    <div class="mb-3">
        <label>CPF
            <input type="text" name="cpf_cliente" class="form-control"
                   value="<?php echo $row->cpf_cliente; ?>" required>
        </label>
    </div>
    ...
    <div class="mb-3">
        <label>E-mail
            <input type="email" name="email_cliente" class="form-control"
                   value="<?php echo $row->email_cliente; ?>" required>
        </label>
    </div>
    ...
    <div class="mb-3">
        <label>Telefone
            <input type="text" name="telefone_cliente" class="form-control"
                   value="<?php echo $row->telefone_cliente; ?>">
        </label>
    </div>
    ...
    <div class="mb-3">
        <label>Endereço
            <input type="text" name="endereco_cliente" class="form-control"
                   value="<?php echo $row->endereco_cliente; ?>">
        </label>
    </div>

    <div class="mb-3">
        <label>Data de Nascimento
            <input type="date" name="dt_nasc_cl
